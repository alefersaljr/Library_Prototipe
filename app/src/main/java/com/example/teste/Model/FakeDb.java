...
public class FakeDb {
    ...
    public FakeDb(){
        ...
        book.setUrl1("https://myredabyss.files.wordpress.com/2015/03/labyrinth.gif?w=720");
        book.setUrl2("https://upload.wikimedia.org/wikipedia/commons/9/9d/MAZE_40x20_DFS_no_deadends.png");
        book.setUrl3("https://es.testsworld.net/files/2013/05/test-de-logica-6-300x225.jpg");
